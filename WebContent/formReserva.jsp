		...
		<div class="row">
			<div class="col">
				...
				<form action="CrearReserva" method="post">
					<input type="hidden" name="id_parcela" value="" />
					<table>
						<tr>
							<td>Nombre:</td>
						...
						<tr>
							<td>Fecha inicio:</td>
							<td><input type="text" name="fecha_inicio" placeholder="dd-MM-yyy" value=""/></td>
						</tr>
						<tr>
							<td>Fecha fin:</td>
							<td><input type="text" name="fecha_fin" placeholder="dd-MM-yyy" value=""/></td>
						</tr>
						<tr>
							<td>Luz</td>
